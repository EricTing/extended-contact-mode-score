...
WORKING_DIR=/work/jaydy/working/astex_traces/$complex
...
# trace_file=/home/jaydy/Workspace/Bitbucket/geauxdock/data/trajectory.sample.out

mkdir -p $WORKING_DIR
conf_file=$WORKING_DIR/${complex}_new

for conf_file in `ls $WORKING_DIR/${complex}_new*`
do
    echo $conf_file
done
