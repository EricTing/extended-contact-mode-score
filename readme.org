...
2. methods
   1. apply rotation and translation to each ligand
      ...
      2. to calculate xCms for eac complex
         1. use Lpc to find the pocket residues
         2. add virtual points to the pocket residues
         3. calculate the xCms between the variational conformations and the native conformation
